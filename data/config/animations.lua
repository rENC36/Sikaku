...
return {
	...
	btn_mode = {
		default   = { scale = V3(5, 9.5, 1) },
		hover     = { scale = V3(5.3, 9.8, 1), duration = 0.12, easing = gui.EASING_OUTQUAD, cancel = true },
		hover_off = { scale = V3(5, 9.5, 1),       duration = 0.12, easing = gui.EASING_OUTQUAD, cancel = true },
		pressed   = { scale = V3(4, 8, 1), duration = 0.05, easing = gui.EASING_OUTQUAD, cancel = true },
		released  = { scale = V3(4.5, 8.5, 1),       duration = 0.2,  easing = gui.EASING_OUTBACK, cancel = true },
	},
